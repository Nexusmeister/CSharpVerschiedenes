    ...
    public partial class frmAnzeige : Form
    {
        ...
        public void LadeDatenInControls()
        {
            try
            {
                ...
                gbDSKCName.Text = dto.SKCMarkelsheimName;
        ...
        public void SendeSpieldatenAnAnzeige(Partie spielDTO)
        {
            try
            {
                dto = spielDTO;
        ...
        private void TxtDErgebnisdifferenz_TextChanged(object sender, EventArgs e)
        {
            if (sender is TextBox txt)
            {
                ...
                else if (txt.Text.Trim().StartsWith("+") && !txt.BackColor.Equals(Color.LightGreen))
                {
